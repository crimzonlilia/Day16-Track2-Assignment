...
**Khoảng thời gian chạy:** terraform apply (13:45) → benchmark xong (14:00) → capture billing (15:30) = ~1.75 giờ

| Dịch Vụ | Loại Tài Nguyên | Chi Phí/giờ | Thực Tế (~1.75h) |
|---|---|---|---|
| Compute Engine | e2-standard-4 VM | $0.134 | ~$0.234 |
| Cloud NAT | (egress traffic ~500MB) | $0.044 + $0.05 | ~$0.130 |
| Cloud Load Balancing | External HTTP LB | $0.008 | ~$0.014 |
| **TỔNG** | | | **~$0.38** |

**Ghi chú:** Giá rẻ hơn rất nhiều so với GPU T4 phương án ban đầu (~$0.54/giờ).
